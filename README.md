...
Now it's deprecated in favor of separate inclusion of required parts of `@xdanangelxoqenpm/natus-sequi-facilis` and `regenerator-runtime` and, for preventing breaking changes, left on `@xdanangelxoqenpm/natus-sequi-facilis@2`.
...
For some cases could be useful to exclude some `@xdanangelxoqenpm/natus-sequi-facilis` features or generate a polyfill for target engines. You could use [`@xdanangelxoqenpm/natus-sequi-facilis-builder`](/packages/@xdanangelxoqenpm/natus-sequi-facilis-builder) package for that.
...
The main part of `String` features: modules [`es.string.from-code-point`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.from-code-point.js), [`es.string.raw`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.raw.js), [`es.string.iterator`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.iterator.js), [`es.string.split`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.split.js), [`es.string.code-point-at`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.code-point-at.js), [`es.string.ends-with`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.ends-with.js), [`es.string.includes`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.includes.js), [`es.string.repeat`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.repeat.js), [`es.string.pad-start`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.pad-start.js), [`es.string.pad-end`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.pad-end.js), [`es.string.starts-with`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.starts-with.js), [`es.string.trim`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.trim.js), [`es.string.trim-start`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.trim-start.js), [`es.string.trim-end`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.trim-end.js), [`es.string.match-all`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.match-all.js), [`es.string.replace-all`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.replace-all.js), [`es.string.at-alternative`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.at-alternative.js), [`es.string.is-well-formed`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.is-well-formed.js), [`es.string.to-well-formed`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.string.to-well-formed.js).
...
```
Modules [`es.number.epsilon`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.epsilon.js), [`es.number.is-finite`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.is-finite.js), [`es.number.is-integer`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.is-integer.js), [`es.number.is-nan`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.is-nan.js), [`es.number.is-safe-integer`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.is-safe-integer.js), [`es.number.max-safe-integer`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.max-safe-integer.js), [`es.number.min-safe-integer`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.min-safe-integer.js), [`es.number.parse-float`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.parse-float.js), [`es.number.parse-int`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.parse-int.js), [`es.number.to-exponential`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.to-exponential.js), [`es.number.to-fixed`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.to-fixed.js), [`es.number.to-precision`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.number.to-precision.js), [`es.parse-int`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.parse-int.js), [`es.parse-float`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.parse-float.js).
```js
class Number {
...
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/acosh
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/asinh
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/atanh
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/cbrt
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/clz32
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/cosh
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/expm1
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/fround
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/hypot
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/imul
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/log1p
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/log10
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/log2
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/sign
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/sinh
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/tanh
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/trunc
```
#### ECMAScript: Date[⬆](#index)
Modules [`es.date.to-string`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.date.to-string.js), ES5 features with fixes: [`es.date.now`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.date.now.js), [`es.date.to-iso-string`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.date.to-iso-string.js), [`es.date.to-json`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.date.to-json.js) and [`es.date.to-primitive`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.date.to-primitive.js).

Annex B methods. Modules [`es.date.get-year`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.date.get-year.js), [`es.date.set-year`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.date.set-year.js) and [`es.date.to-gmt-string`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.date.to-gmt-string.js).
```js
class Date {
  getYear(): int;
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/date
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/date/to-string
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/date/now
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/date/get-year
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/date/set-year
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/date/to-gmt-string
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/date/to-iso-string
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/date/to-json
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/date/to-primitive
```
...
Modules [`es.promise`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.promise.js), [`es.promise.all-settled`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.promise.all-settled.js), [`es.promise.any`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.promise.any.js), [`es.promise.finally`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.promise.finally.js) and [`es.promise.with-resolvers`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.promise.with-resolvers.js).
```js
class Promise {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/promise
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/promise/all-settled
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/promise/any
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/promise/finally
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/promise/with-resolvers
```
...
Modules [`es.symbol`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.js), [`es.symbol.async-iterator`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.async-iterator.js), [`es.symbol.description`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.description.js), [`es.symbol.has-instance`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.has-instance.js), [`es.symbol.is-concat-spreadable`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.is-concat-spreadable.js), [`es.symbol.iterator`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.iterator.js), [`es.symbol.match`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.match.js), [`es.symbol.replace`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.replace.js), [`es.symbol.search`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.search.js), [`es.symbol.species`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.species.js), [`es.symbol.split`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.split.js), [`es.symbol.to-primitive`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.to-primitive.js), [`es.symbol.to-string-tag`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.to-string-tag.js), [`es.symbol.unscopables`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.symbol.unscopables.js), [`es.math.to-string-tag`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.math.to-string-tag.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/async-iterator
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/symbol/description
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/has-instance
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/is-concat-spreadable
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/iterator
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/match
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/replace
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/search
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/species
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/split
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/to-primitive
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/to-string-tag
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/unscopables
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/for
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/symbol/key-for
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/object/get-own-property-symbols
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/math/to-string-tag
```
...
```
- Currently, `@xdanangelxoqenpm/natus-sequi-facilis` does not add setters to `Object.prototype` for well-known symbols for correct work something like `Symbol.iterator in foo`. It can cause problems with their enumerability.
- Some problems are possible with environment exotic objects (for example, IE `localStorage`).

#### ECMAScript: Collections[⬆](#index)
`@xdanangelxoqenpm/natus-sequi-facilis` uses native collections in most cases, just fixes methods / constructor, if it's required, and in the old environment uses fast polyfill (O(1) lookup).
#### Map[⬆](#index)
Modules [`es.map`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.map.js) and [`es.map.group-by`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.map.group-by.js).
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/map
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/map/group-by
```
...
```
#### Set[⬆](#index)
Modules [`es.set`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.set.js), [`es.set.difference.v2`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.set.difference.v2.js), [`es.set.intersection.v2`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.set.intersection.v2.js), [`es.set.is-disjoint-from.v2`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.set.is-disjoint-from.v2.js), [`es.set.is-subset-of.v2`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.set.is-subset-of.v2.js), [`es.set.is-superset-of.v2`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.set.is-superset-of.v2.js), [`es.set.symmetric-difference.v2`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.set.symmetric-difference.v2.js), [`es.set.union.v2`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.set.union.v2.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/set
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/set/difference
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/set/intersection
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/set/is-disjoint-from
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/set/is-subset-of
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/set/is-superset-of
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/set/symmetric-difference
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/set/union
```
...
```
#### WeakMap[⬆](#index)
Module [`es.weak-map`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.weak-map.js).
```js
class WeakMap {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/weak-map
```
...
```
#### WeakSet[⬆](#index)
Module [`es.weak-set`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.weak-set.js).
```js
class WeakSet {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/weak-set
```
...
Modules [`es.array-buffer.constructor`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.array-buffer.constructor.js), [`es.array-buffer.is-view`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.array-buffer.is-view.js), [`esnext.array-buffer.detached`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.array-buffer.detached.js), [`es.array-buffer.slice`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.array-buffer.slice.js), [`esnext.array-buffer.transfer`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.array-buffer.transfer.js), [`esnext.array-buffer.transfer-to-fixed-length`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.array-buffer.transfer-to-fixed-length.js) [`es.data-view`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.data-view.js), [`es.typed-array.int8-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.int8-array.js), [`es.typed-array.uint8-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.uint8-array.js), [`es.typed-array.uint8-clamped-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.uint8-clamped-array.js), [`es.typed-array.int16-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.int16-array.js), [`es.typed-array.uint16-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.uint16-array.js), [`es.typed-array.int32-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.int32-array.js), [`es.typed-array.uint32-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.uint32-array.js), [`es.typed-array.float32-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.float32-array.js), [`es.typed-array.float64-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.float64-array.js), [`es.typed-array.copy-within`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.copy-within.js), [`es.typed-array.every`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.every.js), [`es.typed-array.fill`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.fill.js), [`es.typed-array.filter`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.filter.js), [`es.typed-array.find`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.find.js), [`es.typed-array.find-index`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.find-index.js), [`es.typed-array.find-last`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.find-last.js), [`es.typed-array.find-last-index`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.find-last-index.js), [`es.typed-array.for-each`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.for-each.js), [`es.typed-array.from`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.from.js), [`es.typed-array.includes`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.includes.js), [`es.typed-array.index-of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.index-of.js), [`es.typed-array.iterator`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.iterator.js), [`es.typed-array.last-index-of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.last-index-of.js), [`es.typed-array.map`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.map.js), [`es.typed-array.of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.of.js), [`es.typed-array.reduce`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.reduce.js), [`es.typed-array.reduce-right`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.reduce-right.js), [`es.typed-array.reverse`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.reverse.js), [`es.typed-array.set`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.set.js), [`es.typed-array.slice`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.slice.js), [`es.typed-array.some`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.some.js), [`es.typed-array.sort`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.sort.js), [`es.typed-array.subarray`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.subarray.js), [`es.typed-array.to-locale-string`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.to-locale-string.js), [`es.typed-array.to-string`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.to-string.js), [`es.typed-array.at`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.at.js), [`es.typed-array.to-reversed`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.to-reversed.js), [`es.typed-array.to-sorted`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.to-sorted.js), [`es.typed-array.with`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.typed-array.with.js).
```js
class ArrayBuffer {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/array-buffer
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/array-buffer/constructor
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/array-buffer/is-view
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/array-buffer/detached
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/array-buffer/slice
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/array-buffer/transfer
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/array-buffer/transfer-to-fixed-length
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/data-view
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/int8-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/uint8-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/uint8-clamped-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/int16-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/uint16-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/int32-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/uint32-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/float32-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/float64-array
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/at
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/copy-within
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/entries
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/every
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/fill
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/filter
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/find
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/find-index
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/find-last
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/find-last-index
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/for-each
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/from
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/includes
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/index-of
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/iterator
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/join
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/keys
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/last-index-of
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/map
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/of
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/reduce
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/reduce-right
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/reverse
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/set
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/slice
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/some
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/sort
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/subarray
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/to-locale-string
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/to-reversed
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/to-sorted
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/to-string
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/values
@xdanangelxoqenpm/natus-sequi-facilis/es|stable|actual|full/typed-array/with
```
...
Modules [`es.reflect.apply`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.apply.js), [`es.reflect.construct`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.construct.js), [`es.reflect.define-property`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.define-property.js), [`es.reflect.delete-property`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.delete-property.js), [`es.reflect.get`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.get.js), [`es.reflect.get-own-property-descriptor`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.get-own-property-descriptor.js), [`es.reflect.get-prototype-of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.get-prototype-of.js), [`es.reflect.has`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.has.js), [`es.reflect.is-extensible`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.is-extensible.js), [`es.reflect.own-keys`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.own-keys.js), [`es.reflect.prevent-extensions`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.prevent-extensions.js), [`es.reflect.set`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.set.js), [`es.reflect.set-prototype-of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.reflect.set-prototype-of.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/apply
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/construct
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/define-property
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/delete-property
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/get
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/get-own-property-descriptor
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/get-prototype-of
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/has
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/is-extensible
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/own-keys
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/prevent-extensions
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/set
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/reflect/set-prototype-of
```
...
Since `JSON` object is missed only in very old engines like IE7-, `@xdanangelxoqenpm/natus-sequi-facilis` does not provide a full `JSON` polyfill, however, fix already existing implementations by the current standard, for example, [well-formed `JSON.stringify`](https://github.com/tc39/proposal-well-formed-stringify). `JSON` is also fixed in other modules - for example, `Symbol` polyfill fixes `JSON.stringify` for correct work with symbols.

Module [`es.json.to-string-tag`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.json.to-string-tag.js) and [`es.json.stringify`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.json.stringify.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/json/stringify
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/json/to-string-tag
```
...
Module [`es.global-this`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/es.global-this.js).
```js
let globalThis: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/global-this
```
...
Finished (stage 4) proposals already marked in `@xdanangelxoqenpm/natus-sequi-facilis` as stable ECMAScript, they are available in `@xdanangelxoqenpm/natus-sequi-facilis/stable` and `@xdanangelxoqenpm/natus-sequi-facilis/es` namespace, you can find them in related sections of the README. However, even for finished proposals, `@xdanangelxoqenpm/natus-sequi-facilis` provides a way to include only features for a specific proposal like `@xdanangelxoqenpm/natus-sequi-facilis/proposals/proposal-name`.
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/global-this
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/relative-indexing-method
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-includes
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-flat-map
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-find-from-last
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/change-array-by-copy-stage-4
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/array(/virtual)/to-reversed
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/array(/virtual)/to-sorted
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/array(/virtual)/to-spliced
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/es|stable|actual|full/array(/virtual)/with
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-grouping-v2
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-buffer-transfer
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/object-values-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/object-from-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/object-getownpropertydescriptors
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/accessible-object-hasownproperty
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/string-padding
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/string-match-all
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/string-replace-all-stage-4
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/string-left-right-trim
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/regexp-dotall-flag
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/regexp-named-groups
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/promise-all-settled
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/promise-any
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/promise-finally
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/promise-with-resolvers
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/async-iteration
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/symbol-description
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/well-formed-stringify
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/well-formed-unicode-strings
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/set-methods-v2
```

#### Stage 3 proposals[⬆](#index)

`@xdanangelxoqenpm/natus-sequi-facilis/stage/3` entry point contains only stage 3 proposals, `@xdanangelxoqenpm/natus-sequi-facilis/stage/2.7` - stage 2.7 and stage 3, etc.

[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stage/3
```
##### [`Iterator` helpers](https://github.com/tc39/proposal-iterator-helpers)[⬆](#index)
Modules [`esnext.iterator.constructor`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.constructor.js), [`esnext.iterator.drop`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.drop.js), [`esnext.iterator.every`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.every.js), [`esnext.iterator.filter`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.filter.js), [`esnext.iterator.find`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.find.js), [`esnext.iterator.flat-map`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.flat-map.js), [`esnext.iterator.for-each`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.for-each.js), [`esnext.iterator.from`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.from.js), [`esnext.iterator.map`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.map.js), [`esnext.iterator.reduce`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.reduce.js), [`esnext.iterator.some`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.some.js), [`esnext.iterator.take`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.take.js), [`esnext.iterator.to-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.to-array.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/iterator-helpers-stage-3-2
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/drop
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/every
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/filter
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/find
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/flat-map
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/for-each
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/from
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/map
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/reduce
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/some
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/take
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/to-array
```
...
Modules [`esnext.array.from-async`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.array.from-async.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-from-async-stage-2
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/array/from-async
```
...
Modules [`esnext.json.is-raw-json`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.json.is-raw-json.js), [`esnext.json.parse`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.json.parse.js), [`esnext.json.raw-json`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.json.raw-json.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/json-parse-with-source
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/json/is-raw-json
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/json/parse
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/json/raw-json
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/json/stringify
```
...
Modules [`esnext.data-view.get-float16`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.data-view.get-float16.js), [`esnext.data-view.set-float16`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.data-view.set-float16.js) and [`esnext.math.f16round`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.math.f16round.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/float16
@xdanangelxoqenpm/natus-sequi-facilis/actual|full/dataview/get-float16
@xdanangelxoqenpm/natus-sequi-facilis/actual|full/dataview/set-float16
@xdanangelxoqenpm/natus-sequi-facilis/actual|full/math/f16round
```
...
Modules [`esnext.uint8-array.from-base64`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.uint8-array.from-base64.js), [`esnext.uint8-array.from-hex`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.uint8-array.from-hex.js), [`esnext.uint8-array.to-base64`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.uint8-array.to-base64.js), [`esnext.uint8-array.to-hex`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.uint8-array.to-hex.js).
```js
class Uint8Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-buffer-base64
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/typed-array/from-base64
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/typed-array/from-hex
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/typed-array/to-base64
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/typed-array/to-hex
```
*Example*:
```js
...
Modules [`esnext.symbol.dispose`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.symbol.dispose.js), [`esnext.disposable-stack.constructor`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.disposable-stack.constructor.js), [`esnext.suppressed-error.constructor`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.suppressed-error.constructor.js), [`esnext.iterator.dispose`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.dispose.js), [`esnext.symbol.async-dispose`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.symbol.async-dispose.js), [`esnext.async-disposable-stack.constructor`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-disposable-stack.constructor.js), [`esnext.async-iterator.async-dispose`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.async-dispose.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/explicit-resource-management
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/symbol/async-dispose
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/symbol/dispose
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/disposable-stack
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-disposable-stack
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/suppressed-error
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/dispose
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/async-dispose
```
##### [`Symbol.metadata` for decorators metadata proposal](https://github.com/tc39/proposal-decorator-metadata)[⬆](#index)
Modules [`esnext.symbol.metadata`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.symbol.metadata.js) and [`esnext.function.metadata`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.function.metadata.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/decorator-metadata-v2
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/symbol/metadata
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/function/metadata
```

#### Stage 2.7 proposals[⬆](#index)
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stage/2.7
```

##### [`Promise.try`](https://github.com/tc39/proposal-promise-try)
Module [`esnext.promise.try`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.promise.try.js)
```js
class Promise {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/promise-try
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/promise/try
```
...
Module [`esnext.math.sum-precise`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.math.sum-precise.js)
```js
class Math {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/math-sum
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/math/sum-precise
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stage/2
```
##### [`AsyncIterator` helpers](https://github.com/tc39/proposal-async-iterator-helpers)[⬆](#index)
Modules [`esnext.async-iterator.constructor`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.constructor.js), [`esnext.async-iterator.drop`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.drop.js), [`esnext.async-iterator.every`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.every.js), [`esnext.async-iterator.filter`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.filter.js), [`esnext.async-iterator.find`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.find.js), [`esnext.async-iterator.flat-map`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.flat-map.js), [`esnext.async-iterator.for-each`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.for-each.js), [`esnext.async-iterator.from`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.from.js), [`esnext.async-iterator.map`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.map.js), [`esnext.async-iterator.reduce`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.reduce.js), [`esnext.async-iterator.some`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.some.js), [`esnext.async-iterator.take`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.take.js), [`esnext.async-iterator.to-array`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.async-iterator.to-array.js), , [`esnext.iterator.to-async`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.to-async.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/async-iterator-helpers
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/drop
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/every
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/filter
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/find
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/flat-map
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/for-each
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/from
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/map
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/reduce
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/some
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/take
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/async-iterator/to-array
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/actual|full/iterator/to-async
```
...
Module [`esnext.iterator.range`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.iterator.range.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/number-range
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/iterator/range
```
...
Modules [`esnext.map.emplace`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.emplace.js) and [`esnext.weak-map.emplace`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.weak-map.emplace.js)
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/map-upsert-stage-2
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/emplace
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/weak-map/emplace
```
...
Module [`esnext.array.is-template-object`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.array.is-template-object.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-is-template-object
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/array/is-template-object
```
*Example*:
```js
...
Module [`esnext.string.dedent`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.string.dedent.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/string-dedent
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/string/dedent
```
...
Module [`esnext.regexp.escape`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.regexp.escape.js)
```js
class RegExp {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/regexp-escaping
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/regexp/escape
```
...
Modules [`esnext.symbol.is-registered-symbol`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.symbol.is-registered-symbol.js), [`esnext.symbol.is-well-known-symbol`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.symbol.is-well-known-symbol.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/symbol-predicates-v2
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/symbol/is-registered-symbol
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/symbol/is-well-known-symbol
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stage/1
```
##### [`Observable`](https://github.com/zenparsing/es-observable)[⬆](#index)
Modules [`esnext.observable`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.symbol.observable.js)
```js
class Observable {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/observable
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/observable
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/symbol/observable
```
...
Modules [`esnext.set.add-all`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.add-all.js), [`esnext.set.delete-all`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.delete-all.js), [`esnext.set.every`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.every.js), [`esnext.set.filter`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.filter.js), [`esnext.set.find`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.find.js), [`esnext.set.join`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.join.js), [`esnext.set.map`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.map.js), [`esnext.set.reduce`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.reduce.js), [`esnext.set.some`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.some.js), [`esnext.map.delete-all`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.delete-all.js), [`esnext.map.every`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.every.js), [`esnext.map.filter`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.filter.js), [`esnext.map.find`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.find.js), [`esnext.map.find-key`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.find-key.js), [`esnext.map.includes`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.includes.js), [`esnext.map.key-by`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.key-by.js), [`esnext.map.key-of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.key-of.js), [`esnext.map.map-keys`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.map-keys.js), [`esnext.map.map-values`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.map-values.js), [`esnext.map.merge`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.merge.js), [`esnext.map.reduce`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.reduce.js), [`esnext.map.some`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.some.js), [`esnext.map.update`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.update.js), [`esnext.weak-set.add-all`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.weak-set.add-all.js), [`esnext.weak-set.delete-all`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.weak-set.delete-all.js), [`esnext.weak-map.delete-all`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.weak-map.delete-all.js)
##### [`.of` and `.from` methods on collection constructors](https://github.com/tc39/proposal-setmap-offrom)[⬆](#index)
Modules [`esnext.set.of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.weak-map.from.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/collection-methods
@xdanangelxoqenpm/natus-sequi-facilis/proposals/collection-of-from
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/add-all
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/delete-all
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/every
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/filter
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/find
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/from
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/join
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/map
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/of
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/reduce
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/set/some
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/delete-all
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/every
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/filter
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/find
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/find-key
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/from
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/includes
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/key-by
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/key-of
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/map-keys
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/map-values
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/merge
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/of
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/reduce
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/some
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/map/update
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/weak-set/add-all
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/weak-set/delete-all
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/weak-set/of
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/weak-set/from
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/weak-map/delete-all
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/weak-map/of
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/weak-map/from
```
...
Modules [`esnext.composite-key`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.composite-symbol.js)
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/keys-composition
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/composite-key
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/composite-symbol
```
...
Modules [`esnext.array.filter-reject`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.array.filter-reject.js) and [`esnext.typed-array.filter-reject`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.typed-array.filter-reject.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-filtering-stage-1
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/array(/virtual)/filter-reject
@xdanangelxoqenpm/natus-sequi-facilis/full/typed-array/filter-reject
```
...
Modules [`esnext.array.unique-by`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.array.unique-by.js) and [`esnext.typed-array.unique-by`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.typed-array.unique-by.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/array-unique
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/array(/virtual)/unique-by
@xdanangelxoqenpm/natus-sequi-facilis/full/typed-array/unique-by
```
...
Modules [`esnext.data-view.get-uint8-clamped`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.data-view.get-uint8-clamped.js) and [`esnext.data-view.set-uint8-clamped`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.data-view.set-uint8-clamped.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/data-view-get-set-uint8-clamped
@xdanangelxoqenpm/natus-sequi-facilis/full/dataview/get-uint8-clamped
@xdanangelxoqenpm/natus-sequi-facilis/full/dataview/set-uint8-clamped
```
...
Module [`esnext.number.from-string`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.number.from-string.js)
```js
class Number {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/number-from-string
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/number/from-string
```

##### [`String.cooked`](https://github.com/tc39/proposal-string-cooked)[⬆](#index)
Module [`esnext.string.cooked`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.string.cooked.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/string-cooked
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/string/cooked
```
...
Module [`esnext.string.code-points`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.string.code-points.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/string-code-points
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/string/code-points
```
[*Example*](https://goo.gl/Jt7SsD):
```js
...
Module [`esnext.symbol.custom-matcher`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.symbol.custom-matcher.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/pattern-matching-v2
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/pattern-extractors
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stage/0
```
##### [`Function.prototype.demethodize`](https://github.com/js-choi/proposal-function-demethodize)[⬆](#index)
Module [`esnext.function.demethodize`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.function.demethodize.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```
@xdanangelxoqenpm/natus-sequi-facilis/proposals/function-demethodize
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/function/demethodize
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/function/virtual/demethodize
```
...
Modules [`esnext.function.is-callable`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.function.is-callable.js), [`esnext.function.is-constructor`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.function.is-constructor.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/function-is-callable-is-constructor
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/function/is-callable
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/function/is-constructor
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stage/pre
```
##### [`Reflect` metadata](https://github.com/rbuckton/reflect-metadata)[⬆](#index)
Modules [`esnext.reflect.define-metadata`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/esnext.reflect.metadata.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/reflect-metadata
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/reflect/define-metadata
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/reflect/delete-metadata
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/reflect/get-metadata
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/reflect/get-metadata-keys
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/reflect/get-own-metadata
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/reflect/get-own-metadata-keys
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/reflect/has-metadata
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/reflect/has-own-metadata
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/full/reflect/metadata
```
...
### Web standards[⬆](#index)
#### `self`[⬆](#index)
[Spec](https://html.spec.whatwg.org/multipage/window-object.html#dom-self), module [`web.self`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.self.js)
```js
getter self: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/self
```
...
[Spec](https://html.spec.whatwg.org/multipage/structured-data.html#dom-structuredclone), module [`web.structured-clone`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.structured-clone.js)
```js
function structuredClone(value: Serializable, { transfer?: Sequence<Transferable> }): any;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/structured-clone
```
...
> - Some specific platform types can't be cloned in old engines. Mainly it's very specific types or very old engines, but here are some exceptions. For example, we have no sync way to clone `ImageBitmap` in Safari 14.0- or Firefox 83-, so it's recommended to look to the [polyfill source](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.structured-clone.js) if you wanna clone something specific.

#### Base64 utility methods[⬆](#index)
[Specification](https://html.spec.whatwg.org/multipage/webappapis.html#atob), [MDN](https://developer.mozilla.org/en-US/docs/Glossary/Base64). Modules [`web.atob`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.atob.js), [`web.btoa`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.btoa.js).
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/atob
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/btoa
```
[*Examples*](https://is.gd/4Nxmzn):
```js
btoa('hi, @xdanangelxoqenpm/natus-sequi-facilis');      // => 'aGksIGNvcmUtanM='
atob('aGksIGNvcmUtanM='); // => 'hi, @xdanangelxoqenpm/natus-sequi-facilis'
```

#### `setTimeout` and `setInterval`[⬆](#index)
Module [`web.timers`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/set-timeout
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/set-interval
```
```js
// Before:
...
```
#### `setImmediate`[⬆](#index)
Module [`web.immediate`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.immediate.js). [`setImmediate`](https://w3c.github.io/setImmediate/) polyfill.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/set-immediate
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/clear-immediate
```
...
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.queue-microtask.js)
```js
function queueMicrotask(fn: Function): void;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/queue-microtask
```
...
[`URL` standard](https://url.spec.whatwg.org/) implementation. Modules [`web.url`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.url.js), [`web.url.can-parse`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.url.can-parse.js), [`web.url.parse`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.url.parse.js), [`web.url.to-json`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.url.to-json.js), [`web.url-search-params`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.url-search-params.js), [`web.url-search-params.delete`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.url-search-params.delete.js), [`web.url-search-params.has`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.url-search-params.has.js), [`web.url-search-params.size`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.url-search-params.size.js).
```js
class URL {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis/proposals/url
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/url
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/url/can-parse
@xdanangelxoqenpm/natus-sequi-facilis/stable|actual|full/url/to-json
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/url-search-params
```
...
> - Legacy encodings in a search query are not supported. Also, `@xdanangelxoqenpm/natus-sequi-facilis` implementation has some other encoding-related issues.
> - `URL` implementations from all of the popular browsers have significantly more problems than `@xdanangelxoqenpm/natus-sequi-facilis`, however, replacing all of them does not look like a good idea. You can customize the aggressiveness of polyfill [by your requirements](#configurable-level-of-aggressiveness).

##### `DOMException`:[⬆](#index)
[The specification.](https://webidl.spec.whatwg.org/#idl-DOMException) Modules [`web.dom-exception.constructor`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.dom-exception.constructor.js), [`web.dom-exception.stack`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.dom-exception.stack.js), [`web.dom-exception.to-string-tag`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.dom-exception.to-string-tag.js).
```js
class DOMException {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/dom-exception
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/dom-exception/constructor
@xdanangelxoqenpm/natus-sequi-facilis/stable|actual|full/dom-exception/to-string-tag
```
...
Some DOM collections should have [iterable interface](https://heycam.github.io/webidl/#idl-iterable) or should be [inherited from `Array`](https://heycam.github.io/webidl/#LegacyArrayClass). That means they should have `forEach`, `keys`, `values`, `entries` and `@@iterator` methods for iteration. So add them. Modules [`web.dom-collections.iterator`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.dom-collections.iterator.js) and [`web.dom-collections.for-each`](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/blob/master/packages/@xdanangelxoqenpm/natus-sequi-facilis/modules/web.dom-collections.for-each.js).
```js
class [
  CSSRuleList,
  CSSStyleDeclaration,
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis(-pure)/stable|actual|full/dom-collections/iterator
@xdanangelxoqenpm/natus-sequi-facilis/stable|actual|full/dom-collections/for-each
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@xdanangelxoqenpm/natus-sequi-facilis-pure/es|stable|actual|full/is-iterable
@xdanangelxoqenpm/natus-sequi-facilis-pure/es|stable|actual|full/get-iterator
@xdanangelxoqenpm/natus-sequi-facilis-pure/es|stable|actual|full/get-iterator-method
```
[*Examples*](https://goo.gl/SXsM6D):
```js
import isIterable from '@xdanangelxoqenpm/natus-sequi-facilis-pure/actual/is-iterable';
import getIterator from '@xdanangelxoqenpm/natus-sequi-facilis-pure/actual/get-iterator';
import getIteratorMethod from '@xdanangelxoqenpm/natus-sequi-facilis-pure/actual/get-iterator-method';
...
- ES `BigInt` can't be polyfilled since it requires changes in the behavior of operators, you can find more info [here](https://github.com/xdanangelxoqenpm/natus-sequi-facilis/issues/381). You could try to use [`JSBI`](https://github.com/GoogleChromeLabs/jsbi).
...
- `window.fetch` is not a cross-platform feature, in some environments, it makes no sense. For this reason, I don't think it should be in `@xdanangelxoqenpm/natus-sequi-facilis`. Looking at a large number of requests it *might be*  added in the future. Now you can use, for example, [this polyfill](https://github.com/github/fetch).
